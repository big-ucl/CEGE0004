...
- [Accepted papers 2025](https://ecir2025.eu/accepted-papers/)
...
Team Chaos:
* [Paper: 25 years on: Is LetNet-5 still relevant](https://github.com/big-ucl/CEGE0004/blob/master/10%20-%20Week/examples/2023-24/Chaos/25%20years%20on%20Is%20LeNet-5%20still%20relevant.pdf)
* [Presentation](https://github.com/big-ucl/CEGE0004/blob/master/10%20-%20Week/examples/2023-24/Chaos/Presentation.pdf)
...
Mienye, I. D., Obaido, G., Aruleba, K., & Dada, O. A. (2022). Enhanced Prediction of Chronic Kidney Disease Using Feature Selection and Boosted Classifiers. Lecture Notes in Networks and Systems, 527–537.

Liu, F. T., Ting, K. M., & Zhou, Z.-H. (2008). Isolation Forest. 2008 Eighth IEEE International Conference on Data Mining, 413–422.

An, S., Lee, M., Park, S., Yang, H., & So, J. (2020). An Ensemble of Simple Convolutional Neural Network Models for MNIST Digit Recognition. ArXiv.org. 
...
Schlatt, F., Fröbe, M., & Hagen, M. (2024). Investigating the Effects of Sparse Attention on Cross-Encoders. Lecture Notes in Computer Science, 173–190.
‌‌‌
